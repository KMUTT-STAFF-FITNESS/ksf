      ...
      <div className="flex flex-1 overflow-auto">
        ...
        <div className="w-full lg:w-1/3 px-2">
          ...
          <BtnNext
            ...
            onClick={() =>
              navigate(
                `https://std-sso-fe.sit.kmutt.ac.th/login?response_type=code&client_id=u1UOLdKI&redirect_uri=http://ksf.sit.kmutt.ac.th:8000/checking&state=ksf_login`
              )
            }
          />
          <BtnRigis
            ...
            onClick={() =>
              navigate(
                `https://std-sso-fe.sit.kmutt.ac.th/login?response_type=code&client_id=u1UOLdKI&redirect_uri=http://ksf.sit.kmutt.ac.th:8000/checking&state=ksf_register`
              )
            }
          />
        </div>
